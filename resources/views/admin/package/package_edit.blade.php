...
@section('button')
    <div>
        <a href="{{ route('admin_package') }}" class="btn btn-primary">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="package_name"
                                            value="{{ $package_single->package_name }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="package_price"
                                            value="{{ $package_single->package_price }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="package_days"
                                            value="{{ $package_single->package_days }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="package_display_time"
                                            value="{{ $package_single->package_display_time }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="total_allowed_jobs"
                                            value="{{ $package_single->total_allowed_jobs }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="total_allowed_featured_jobs"
                                            value="{{ $package_single->total_allowed_featured_jobs }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="total_allowed_photos"
                                            value="{{ $package_single->total_allowed_photos }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="total_allowed_videos"
                                            value="{{ $package_single->total_allowed_videos }}">
                                    </div>
                                </div>
                            </div>
