                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                        ...
                                        <button class="nav-link" id="v-pills-4-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="v-pills-4" aria-selected="false">Featured Jobs</button>
                                        ...
                                        <button class="nav-link" id="v-pills-7-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="v-pills-7" aria-selected="false">SEO Section</button>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea name="text" class="form-control h_100">
                                                            {{ $page_home_data->text }}
                                                        </textarea>
                                                    </div>
                                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-4">
                                                        <label class="form-label">Heading *</label>
                                                        <input type="text" class="form-control"
                                                            name="testimonial_heading" value="">
                                                    </div>
                                                    <div class="mb-4">
                                                        <label class="form-label">Existing Background *</label>
                                                        <div>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea name="meta_description" class="form-control h_100" cols="30" rows="10">
                                                            {{-- {{ $page_home_data->meta_description }} --}}
                                                        </textarea>
                                                    </div>
                                                </div>
                                            </div>
