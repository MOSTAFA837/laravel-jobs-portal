                    ...
                    <div class="item d-flex justify-content-start">
                        ...
                        <div class="text">
                            ...
                            <div class="detail-1 d-flex justify-content-start">
                                <div class="category">{{ $company_single->getCompanyIndustry->name }}</div>
                                <div class="location">{{ $company_single->getCompanyLocation->name }}</div>
                            ...
                            <div class="special">
                                <div class="type">{{ $company_single->get_job_count }} Open Positions</div>
                        ...
                        <div class="summary">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td><b> Industry:</b></td>
                                        <td>{{ $company_single->getCompanyIndustry->name }}</td>
                                    </tr>
                                    <tr>
                                        <td><b> Location:</b></td>
                                        <td>{{ $company_single->getCompanyLocation->name }}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Company Size:</b></td>
                                        <td>{{ $company_single->getCompanySize->name }}</td>
                                    </tr>
