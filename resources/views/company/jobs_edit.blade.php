        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <form action="{{ route('company_job_edit_submit', $job_single->id) }}" method="post">
                        @csrf
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="responsibility" class="form-control editor" cols="30" rows="10">
                                    {{ $job_single->responsibility }}
                                </textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="" class="form-label">Skills and Abilities</label>
                                <textarea name="skill" class="form-control editor" cols="30" rows="10">
                                    {{ $job_single->skill }}
                                </textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea name="education" class="form-control editor" cols="30" rows="10">
                                ...
                                <select name="job_category_id" class="form-control select2">
                                    @foreach ($job_categories as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == $job_single->job_category_id) selected @endif>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="job_location_id" class="form-control select2">
                                    @foreach ($job_locations as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == $job_single->job_location_id) selected @endif>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="job_type_id" class="form-control select2">
                                    @foreach ($job_types as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == $job_single->job_type_id) selected @endif>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="job_experience_id" class="form-control select2">
                                    @foreach ($job_experiences as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == $job_single->job_experience_id) selected @endif>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="job_gender_id" class="form-control select2">
                                    @foreach ($job_genders as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == $job_single->job_gender_id) selected @endif>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="job_salary_range_id" class="form-control select2">
                                    @foreach ($job_salary_ranges as $item)
                                        <option value="{{ $item->id }}"
                                            @if ($item->id == $job_single->job_salary_range_id) selected @endif>
                                            {{ $item->name }}
                                        </option>
                                    @endforeach
                                </select>
