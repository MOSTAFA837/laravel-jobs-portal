                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <select name="gender" class="form-control select2">
                                        <option value="male" @if (Auth::guard('candidate')->user()->gender == 'male') selected @endif>
                                            Male
                                        </option>
                                        <option value="female" @if (Auth::guard('candidate')->user()->gender == 'female') selected @endif>
                                            Female
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="form-group">
                                    <select name="marital_status" class="form-control select2">
                                        <option value="Married" @if (Auth::guard('candidate')->user()->marital_status == 'Married') selected @endif>
                                            Married
                                        </option>
                                        <option value="Unmarried" @if (Auth::guard('candidate')->user()->marital_status == 'Unmarried') selected @endif>
                                            Unmarried
                                        </option>
                                        <option value="Divorced" @if (Auth::guard('candidate')->user()->marital_status == 'Divorced') selected @endif>
                                            Divorced
                                        </option>
                                    </select>
                                </div>
